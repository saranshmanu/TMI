...
class RolesViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func functionToFetchRolesForEachSession() {
        if i == Data.sessions.count{
            // do nothing
        }else{
            let session = String(describing: Data.sessions[i]["sessionId"]!)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.wordOfDay.text = String(describing: Data.sessions[indexPath.row]["wordOfDay"]!)
        cell.meaningOfTheWord.text = String(describing: Data.sessions[indexPath.row]["wordMeaning"]!)
        cell.wordUsage.text = String(describing: Data.sessions[indexPath.row]["wordUsage"]!)
        if roles.count == Data.sessions.count{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        sessionId = String(describing: Data.sessions[indexPath.row]["sessionId"]!)
        if roles.count == Data.sessions.count{
